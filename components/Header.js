      ...
      <header className="bg-blue-500 text-white py-5 px-2 flex flex-col  md:flex-row fixed top-0 right-0 left-0 ">
        ...
        <div>
          ...
          >
            ...
            <Link href="/audit-form" className="text-white my-4 md:my-2">
              Reports
            </Link>
            <Link href="/recommendations" className="text-white my-4 md:my-2">
              Recommendations
            </Link>

            <Link href="/analytics" className="text-white my-4 md:my-2">
              Analytics
            </Link>

            {/* <Link href="/login" className="text-white my-4 md:my-2">
              Login
            </Link>
            <Link href="/profile" className="text-white my-4 md:my-2">
              Profile
            </Link> */}
          </nav>
        </div>
